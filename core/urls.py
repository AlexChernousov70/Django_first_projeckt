...
from .views import ThanksView, ThanksForReviewView, ServiceListView, OrdersListView, OrderDetailView, ServiceCreateView, ReviewCreateView, OrderCreateView, MasterInfoAjaxView, MastersServicesAjaxView
