...
from .views import thanks, orders_list, order_detail, service_list, service_create, create_review, thanks_for_the_review, create_order, get_master_info, masters_services_by_id
