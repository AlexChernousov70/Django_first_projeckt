...
from .views import ThanksView, ServiceListView, OrdersListView, order_detail, service_create, create_review, thanks_for_the_review, order_create, get_master_info, masters_services_by_id
